...
public class ExceptionHandlingMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        catch (ValidationException ex)
        {
            _logger.LogWarning(
                ex,
                "Error de validación. TraceId: {TraceId}",
        ...
        catch (NotFoundException ex)
        {
            _logger.LogWarning(
                ex,
                "Recurso no encontrado. TraceId: {TraceId}",
                context.TraceIdentifier);
        ...
        catch (UnauthorizedBusinessException ex)
        {
            _logger.LogWarning(
                ex,
                "Acceso no autorizado. TraceId: {TraceId}",
                context.TraceIdentifier);
        ...
        catch (BusinessException ex)
        {
            _logger.LogWarning(
                ex,
                "Error de negocio. TraceId: {TraceId}",
                context.TraceIdentifier);
        ...
        catch (DbUpdateException ex)
        {
            _logger.LogWarning(
                ex,
                "Error de persistencia de datos. TraceId: {TraceId}",
                context.TraceIdentifier);
        ...
        catch (Exception ex)
        {
            _logger.LogError(
                ex,
                "Error interno no controlado. TraceId: {TraceId}",
                context.TraceIdentifier);
